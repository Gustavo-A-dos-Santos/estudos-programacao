...
insert into projeto values (4, "NOVO_PROJETO", "Buritis", 1);

insert into funcionario values (null, "Edgar Marinho", "R.Alameda 111", "1959-11-13", "M", 2000.00, null, 2);

update funcionario set salario = 1000 where id_func = 1;

select nome_func as nome from funcionario where (salario>=800 and salario<=1200) and (id_depto = 3 or id_depto = 2); 

select nome_func as nome, endereco from funcionario where id_depto = 1;

select nome_func nome, DATE_FORMAT(data_nasc, '%d/%m/%Y') from  
